      ...
      <div className="flex flex-col lg:flex-row gap-16 items-center">
        <div className="flex-1 max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link to="/register">
              <Button size="lg" className="bg-music-purple hover:bg-music-purple/90 font-medium px-8 py-6 text-base md:text-lg">
                Get Started Free
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <Button size="lg" variant="outline" className="py-6 text-base md:text-lg">
              <Play className="mr-2 h-5 w-5" /> Listen to Examples
            </Button>
          </div>
        </div>
            ...
            <div key={idx}>
              ...
              <ul className="space-y-1">
                {section.links.map((link, i) => (
                  <li key={i}>
                    <a href="#" className="text-black/70 hover:text-blue-500 transition-colors text-sm lg:text-base">
                      {link}
                    </a>
                  </li>
                ))}
